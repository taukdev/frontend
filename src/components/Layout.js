...
//       >
//         {/* Header */}
//         <header className="h-[80px] bg-[#FFFFFF] sticky top-0 text-white py-[20px] md:px-[40px] px-4 flex items-center justify-between">
...
//               {pageTitle}
//               <div className="bg-[#FFFFFF] md:block hidden border border-[#F1F1F4] p-[6px] rounded-[8px] absolute z-1000 top-[50%] left-[-64px] transform -translate-y-1/2">
