      ...
      <div className="flex flex-col bg-white text-center w-[319px] md:w-[610px] h-[546px] md:h-[624px] rounded-[16px] md:rounded-[30px] gap-4 border p-[20px] md:pt-[50px] md:px-[60px] md:pb-[60px] shadow-custom-glow">
        ...
        <div className='flex flex-col mt-[16px] w-[278px] h-[446px] md:w-[490px] md:h-[434px] gap-[52px]'>
          ...
          <div className='h-[76px] md:h-[64px]'>
            <h2 className="leading-[36px] tracking-[-0.5px] text-center text-gray-800 mb-1 text-[20px] md:text-[30px] font-bold">Login To Tauk</h2>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col m-auto text-left w-[278px] h-[318px] md:w-[490px] md:h-[318px] gap-[40px]">
            ...
            <div className='h-[210px]'>
              ...
              <div className='h-[186px]'>
                <div className="h-[78px] gap-[6px]">
                  ...
                  <label htmlFor="email" className="block text-gray-700 mb-[6px] leading-[20px] tracking-[0] h-[20px] text-[16px] font-medium">
                    Email Address
                  </label>
                ...
                <div className="relative h-[78px] gap-[6px] mt-[30px] ">
                  <label htmlFor="password" className="block text-gray-700 mb-[6px] leading-[20px] tracking-[0] h-[20px] text-[16px] font-medium">
                    Password
                  </label>
              ...
              <div className="flex items-center justify-between mb-6  h-[24px] mb-[0px] mt-[24px]">
                <label className="flex items-center text-gray-600 leading-6 tracking-normal w-[140px] text-[16px] font-normal">
                  <button onClick={() => setRemember(prev => !prev)}>
                    {remember ? <Checkbox className="w-[24px] h-[24px] rounded-[6px] mr-[6px] border border-gray-300" /> : <Checkbox className="w-[24px] h-[24px] rounded-[6px] mr-[6px] border border-gray-300" />}
                  </button>
                  Remember me
                </label>
                <a href="resetpassword" className="bg-gradient-to-r from-[#00AEEF] to-[#007FC4] bg-clip-text text-transparent hover:underline leading-6 tracking-normal w-[138px] text-[16px] font-medium">
                  Forgot Password?
                </a>
              </div>
